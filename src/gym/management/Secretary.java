...
public class Secretary {
    ...
    public boolean checkClientForm(Client c, ForumType forumType) {
        ...
        switch (forumType) {
            ...
            case Male:
                if (c.getPerson().getGender() != Gender.Male) {
            ...
            case Female:
                if (c.getPerson().getGender() != Gender.Female) {
                    gym.addAction("Failed registration: Client's gender doesn't match the session's gender requirements");
                    return false;
                }
                break;
            ...
            default:
                // If no specific conditions are necessary for other ForumTypes, do nothing.
                break;
        }
