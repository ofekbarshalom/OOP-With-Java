...
/**
 * Represents a Thai Boxing session with specific details, including
...
public class ThaiBoxingSession implements Session{
    ...
    private final int MAX_PARTICIPANTS = 20; // Maximum number of participants
    private final int PRICE = 100; // Price for participating in the session

    /**
     * Constructs a ThaiBoxing session.
     *
